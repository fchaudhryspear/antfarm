...
Parse the DOMAIN FINDINGS section. Extract only findings for your assigned domain.
...
4. `git add -p` + `git commit -m "fix(code-quality): <description>"`
5. Open or update PR for the branch if needed
