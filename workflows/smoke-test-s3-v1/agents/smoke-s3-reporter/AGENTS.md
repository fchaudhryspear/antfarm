...
or
```
REPORT_STATUS: fail FAILS: <list of failed checks>
```

If you cannot find the information needed, report: `REPORT_STATUS: inconclusive REASON: <explanation>`
